...
export const modkitsFields: Record<string, FieldInfo> = {
  ...
  cameraPos: {
    ...
    description: "Camera index used by Los Santos Customs while previewing the mod.",
    example: "0 uses the default camera for the slot.",
  },
  audioApply: {
    name: "Audio Apply",
    description: "Audio mix multiplier applied when the mod is equipped.",
    example: "1.0 keeps the default audio behavior.",
  },
  weight: {
    name: "Weight",
    description: "Weight or priority value used by the tuning data.",
    example: "Usually 0 for visible mods, positive values for performance steps.",
  },
  turnOffExtra: {
    name: "Turn Off Extra",
    description: "Disables a matching vehicle extra when this part or linked prop is active.",
    example: "Use -1 when no extra should be disabled.",
  },
  disableBonnetCamera: {
    name: "Disable Bonnet Camera",
    description: "Prevents the bonnet camera from activating with this part installed.",
    example: "Useful for tall front-end equipment.",
  },
  allowBonnetSlide: {
    name: "Allow Bonnet Slide",
    description: "Allows the bonnet camera to slide around the part instead of being blocked.",
    example: "Enable when the hood camera still needs to work around the prop.",
  },
  weaponSlot: {
    name: "Weapon Slot",
    description: "Primary weapon mounting slot used by this visible mod.",
    example: "WMS_FRONT, WMS_REAR",
  },
  weaponSlotSecondary: {
    name: "Secondary Weapon Slot",
    description: "Optional secondary weapon mounting slot for this visible mod.",
    example: "WMS_REAR",
  },
  disableProjectileDriveby: {
    name: "Disable Projectile Driveby",
    description: "Blocks projectile drive-bys while this part is active.",
    example: "Used by armor or cage parts that obstruct the firing arc.",
  },
  disableDriveby: {
    name: "Disable Driveby",
    description: "Blocks standard drive-bys while this part is active.",
    example: "Enable for heavy armor packages.",
  },
  disableDrivebySeat: {
    name: "Disable Driveby Seat",
    description: "Blocks drive-bys from the primary seat when this part is active.",
    example: "Typically paired with seating or armor changes.",
  },
  disableDrivebySeatSecondary: {
    name: "Disable Driveby Seat Secondary",
    description: "Blocks drive-bys from the secondary seat when this part is active.",
    example: "Use when rear/passenger fire arcs should also be blocked.",
  },
  linkModelName: {
    name: "Linked Model",
    description: "Auxiliary model emitted inside the linkMods section and referenced by linkedModels.",
    example: "adder_splitter_a",
  },
  liveryName: {
    name: "Livery Name",
    description: "Primary livery label list used by the kit.",
    example: "LIV_POLICE_1",
  },
  livery2Name: {
    name: "Secondary Livery Name",
    description: "Secondary livery label list used by the kit.",
    example: "LIV_POLICE_2",
  },
  statModType: {
    name: "Stat Mod Type",
